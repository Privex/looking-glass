...
from . import base
from .base import AppError, ERRORS
...
def wants_json() -> bool:
    ...
    JSON (e.g. a web browser).
        ...
        ...     return render_template('hello.html', world='example')
...
def handle_error(err_code='UNKNOWN_ERROR', err_msg=None, code: int = None, exc: Exception = None, **kwargs):
    ...
    if base.DEBUG and exc is not None:
